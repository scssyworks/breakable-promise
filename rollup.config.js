...
esmConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/esm/breakablePromise.esm.js',
    format: 'esm'
});
...
esmProdConfig.output = Object.assign({}, esmConfig.output, {
    file: 'dist/esm/breakablePromise.esm.min.js',
    sourcemap: false
});
...
umdConfig.output = Object.assign({}, commonConfig.output, {
    file: 'dist/umd/breakablePromise.js',
    format: 'umd'
});
umdConfig.plugins = [
...
umdProdConfig.output = Object.assign({}, umdConfig.output, {
    file: 'dist/umd/breakablePromise.min.js',
    sourcemap: false
});
...
if (process.env.SERVE) {
    ...
    serveConfig.output = Object.assign({}, commonConfig.output, {
        file: 'dist/render/breakablePromise.iife.js',
        format: 'iife'
    });
    serveConfig.plugins = [
        eslint({
